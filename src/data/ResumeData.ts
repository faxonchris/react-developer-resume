...
export const JOBS_ARRAY : Array<Job> = [
    {
        ...
        skills: [
            "Java", "Angular", "JavaScript", "TypeScript", "SQL", "Python", "Lambda Serverless", "DynamoDB NoSQL", "Scrum", "SQLite"
        ]
    },
    {
    ...
    },
    {
        ...
        skills: [
            "C# .NET Core", "Xamarin", "React.js", "Python Flask", "Mobile app development"
        ]
    }
...
export const PROJECTS_ARRAY : Array<Project> = [
    {
        ...
        skills: [
            "C# .NET Core","Entity Framework Core", "React", "TypeScript", "SQL", "PostgreSQL", "Solidity", "Cryptocurrency", "Ethereum Smart Contracts"
        ]
    },
    {
        projectName: "TutorBase",
        projectDesc: "Rensselaer Center for Open Source - peer-to-peer tutoring network",
        years: "Aug 2021 - May 2022",
        cardBackgroundImageLink: "https://github.com/DangItJason/TutorBase/raw/master/client/src/containers/LandingPage/assets/img/logo2.png",
        ...
        skills: [
            "JavaScript", "React", "Express JS", "MongoDB"
        ]
    },
]